public class App {
  public static void main(String[] args) {
    ...
    // Criação de contas
    Corrente contaCorrente1 =
        new Corrente("Conta Corrente 1", 12345, "João Silva", 123456789);
    Corrente contaCorrente2 =
        new Corrente("Conta Corrente 2", 67890, "Maria Oliveira", 987654321);
